        ...
        <div>
            <div className="hero" id="home">
                        ...
                        <div className="apps">
                            ...
                            <Modal open={app1Open} className="modal">
                                ...
                                <div className="botones">
                                    <button className="button back" onClick={() => setApp1Open(false)}>
                                        <img src="/assets/Arrow.svg" alt="arrow" />
                                        Volver
                                    </button>
                                    <Link className="button" to="/app1">
                                        Ir a Aplicación
                                        <img src="/assets/Arrow.svg" alt="arrow" />
                                    </Link>
                                </div>
                            ...
                            <Modal open={app2Open} className="modal">
                                ...
                                <div className="objetivo">
                                    <span className="subtitulo">Objetivo</span>
                                    <p>Implementar una herramienta de geo-procesamiento web que permita estimar la línea de equilibrio glaciar (ELA - Equilibrium Line Altitude) de forma automatizada para la muestra de glaciares que conforman el inventario del Chile central.</p>
                                </div>
                                ...
                                <div className="descripcion">
                                    ...
                                    <p>La ELA se combina con el clima principalmente a través de las precipitaciones invernales, que se co-relacionan con la acumulación y la temperatura del aire en verano, que se co-relaciona con la ablación, por lo cual los cambios en la elevación de ELA se pueden utilizar para rastrear los cambios en el clima. La ELA no solo se ha utilizado con éxito para evaluar el clima durante antiguas glaciaciones, sino también el balance de masa de glaciares donde no se dispone de tales datos  (Hughes, 2009a)</p>
                ...
                <div className="container scroll">
                    <span>Desliza hacia abajo para mas información...</span>
                </div>
            </div>
            ...
            <div className="encuesta-section">
                <div className="contenido container">
                    <div className="texto">
                        ...
                        <p>Haz clic en el botón para Realizar la encuesta</p>
                    </div>

                    <div className="boton">
                        <a className="button" href="https://docs.google.com/forms/d/e/1FAIpQLSf_Qq53YisdwSBHU5CLuK9mX98Wax17xWu_15k7RVE9gky5Nw/viewform?usp=pp_url&entry.1571147561=Opci%C3%B3n+1" target="_blank" rel="noopener noreferrer">
                            Ir a encuesta
